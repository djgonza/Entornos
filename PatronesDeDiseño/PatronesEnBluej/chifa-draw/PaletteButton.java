...
/**
 * Clase PaletteButton
Una paleta de botones está en uno de los tres estados del botón. Utiliza el interface palette
listener para notificar sobre los cambios de estado.
Se encuentra en el fichero PaletteButton.java y su contenido es el siguiente:
 * @see PaletteListener
 * @see PaletteLayout
 */
public abstract class PaletteButton extends Canvas implements MouseListener, MouseMotionListener 
{
