 ...
 * Un stream de salida que puede ser utilizado para guardar objetos Storable. StorableOutput
 * preserva la identidad del objeto de los objetos guardados.
...
public class StorableOutput extends Object
{
    ...
    {
        if (b)         fStream.print(1);
        else           fStream.print(0);
        space();
    }
